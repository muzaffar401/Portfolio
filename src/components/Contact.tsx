    ...
    return (
        <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8' id='contact'>
            ...
            <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
                ...
                <form className='space-y-4' action="https://getform.io/f/bxojmjna" method="POST">
                    ...
                    <textarea name='Message' className='w-full bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Your Message'></textarea>
